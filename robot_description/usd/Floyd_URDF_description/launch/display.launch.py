"""
Launch file for Floyd_URDF.

Usage:
    ros2 launch Floyd_URDF_description display.launch.py
    ros2 launch Floyd_URDF_description display.launch.py namespace:=robot1
"""
...
def generate_launch_description():
    pkg_dir = get_package_share_directory('Floyd_URDF_description')

    xacro_file = os.path.join(pkg_dir, 'urdf', 'Floyd_URDF.urdf.xacro')
